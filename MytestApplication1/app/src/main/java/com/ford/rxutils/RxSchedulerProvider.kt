...
//open interface RxSchedulerProvider   {
//
//}

open class RxSchedulerProvider constructor() {
//open class RxSchedulerProvider @Inject constructor() {

    open val mainThreadScheduler: Scheduler
        get() = computationScheduler
//        get() = AndroidSchedulers.mainThread()

    open val computationScheduler: Scheduler
