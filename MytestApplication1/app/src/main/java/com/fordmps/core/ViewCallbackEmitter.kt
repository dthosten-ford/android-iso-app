...
public interface ViewCallbackEmitter {
    fun addObserver(baseLifecycleViewModel: BaseLifecycleViewModel)
}
public class ViewCallbackEmitterImpl {
...
//        private set
//    private val viewCallbackObservers: MutableList<ViewCallbackObserver> =
//        ArrayList()
//
...
//                ViewCallback.ON_OPTIONS_ITEM_SELECTED -> observer.onOptionsItemSelected(
//                    data as Int
//                )
//                ViewCallback.ON_REQUEST_PERMISSIONS_RESULT -> if (data != null) {
//                    observer.onPermissionsResult(data as PermissionResult)
//                }
//                ViewCallback.ON_ACTIVITY_RESULT -> if (data != null) {
//                    observer.onActivityResult(data as ActivityResult)
//                }
//                ViewCallback.ON_FRAGMENT_VISIBILITY_CHANGE -> observer.setUserVisibleHint(
//                    data as Boolean
//                )
...
//                ViewCallback.ON_WINDOW_FOCUS_CHANGED -> observer.onWindowFocusChanged(
//                    data as Boolean
//                )
//            }
//        }
