...
public class PaakVehicleControlsViewModel implements PaakVehicleControlsViewModelInterface {
    @Override
    ...
    @Override
    public Object getLocksAssetManager() {
        return null;
    }
    ...
    @Override
    public void checkVehicleState(VehicleInfo vehicleInfo) {
